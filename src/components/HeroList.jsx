import { getHeroList } from "@/libs/getHeroList";
          ...
          <div className="flex flex-wrap -mx-4">
            ...
            <div className="w-full lg:w-1/2 px-4">
              <div className="flex flex-wrap lg:mb-4 lg:ml-6">
                <Image width={200} height={300} className="w-full md:w-1/2 lg:w-1/3 h-64 p-2 object-cover rounded-4xl lg:rounded-br-none"
                  src={Hero.image1}
                  alt="Top Image 1"
                />
                <Image width={200} height={300} className="w-full md:w-1/2 lg:w-2/3 h-64 p-2 object-cover rounded-4xl lg:rounded-bl-none"
                  src={Hero.image2}
                  alt="Top Image 2"
                />
              </div>
              <div className="flex flex-wrap lg:mb-4 lg:mr-6">
                <Image width={200} height={300} className="w-full md:w-1/2 lg:w-2/3 h-64 p-2 object-cover rounded-4xl lg:rounded-br-none"
                  src={Hero.image3}
                  alt="Top Image 3"
                />
                <Image width={200} height={300} className="w-full md:w-1/2 lg:w-1/3 h-64 p-2 object-cover rounded-4xl lg:rounded-bl-none"
                  src={Hero.image4}
                  alt="Top Image 4"
                />
              </div>
          ...
          <div className="mt-auto">
            ...
            <div className="text-center">
              <a className="inline-block px-1" href="#">
                <img src="atis-assets/social/facebook.svg" alt="icon" />
              </a>
              <a className="inline-block px-1" href="#">
                <img src="atis-assets/social/twitter.svg" alt="icon" />
              </a>
              <a className="inline-block px-1" href="#">
                <img src="atis-assets/social/instagram.svg" alt="icon" />
              </a>
            </div>
          </div>
        </nav>
